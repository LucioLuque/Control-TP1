...
\begin{itemize}
  \item $P = 0$: la planta $G(s)$ no tiene polos en el semiplano derecho estricto (el polo en $s=0$ está sobre el eje imaginario y se rodea por un semicírculo de radio $\varepsilon\to 0$ que no encierra).
