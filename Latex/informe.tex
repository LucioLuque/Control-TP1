...
Dado que valores adecuados requieren $\text{MG} > 6\ \si{dB}$ y $\text{MF} \approx 30^\circ$--$60^\circ$, el sistema ya posee márgenes holgados. Por lo tanto, no es estrictamente necesario introducir un compensador por motivos de estabilidad.
...
\end{align}
	...
	{Demostración de $e_{ss}=0$.}
\

Para una referencia rampa (\(R(s)=1/s\)) y una perturbación constante de magnitud $0.2$, definimos
\[
  E(s)=R(s)-\Theta(s)
\]
y
